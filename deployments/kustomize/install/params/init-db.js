const mongoHost = process.env.DISEASE_MONITOR_API_MONGODB_HOST
const mongoPort = process.env.DISEASE_MONITOR_API_MONGODB_PORT

const mongoUser = process.env.DISEASE_MONITOR_API_MONGODB_USERNAME
const mongoPassword = process.env.DISEASE_MONITOR_API_MONGODB_PASSWORD

const database = process.env.DISEASE_MONITOR_API_MONGODB_DATABASE
const collection = process.env.DISEASE_MONITOR_API_MONGODB_COLLECTION
...
let result = db[collection].insertMany([
    {
        ...
        "predefinedDiseases": [
            { "value": "SARS-CoV-19", "code": "covid" },
            { "value": "Malária", "code": "malaria" },
            { "value": "Slintačka a krívačka", "code": "slak" }
        ]
    }
]);
